            ...
            $items = [
                ...
                [
                    'label' => $this->render('_label', [
                        'isRoot' => true,
                        'icon' => 'fa fa-unlock',
                        'title' => RbacModule::translate('module', 'Role & Permissions')
                    ]),
                ...
                [
                    'label' => $this->render('_label', [
                        'isRoot' => true,
                        'title' => Yii::t('app', 'Master')
                    ]),
                    'url' => ['#'],
                    'options' => ['class' => 'treeview'],
                    'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER),
                    'items' => [
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Dokter')
                            ]),
                            'url' => ['/master/dokter/index']
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Provinsi')
                            ]),
                            'url' => ['/master/provinsi/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_PROVINSI),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Kota')
                            ]),
                            'url' => ['/master/kota/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_KOTA),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Kecamatan')
                            ]),
                            'url' => ['/master/kecamatan/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_KECAMATAN),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Kelurahan')
                            ]),
                            'url' => ['/master/kelurahan/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_KELURAHAN),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Penyakit')
                            ]),
                            'url' => ['/master/penyakit/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_PENYAKIT),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Unit')
                            ]),
                            'url' => ['/master/unit/index'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_UNIT),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Pabrik')
                            ]),
                            'url' => ['/pabrik'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_PABRIK),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Satuan')
                            ]),
                            'url' => ['/apt-satuan'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_SATUAN),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Satuan Besar')
                            ]),
                            'url' => ['/apt-satuan-besar'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_SATUAN_BESAR),
                        ],
                        [
                            'label' => $this->render('_label', [
                                'icon' => 'far fa-circle',
                                'title' => Yii::t('app', 'Obat')
                            ]),
                            'url' => ['/apt-obat'],
                            'visible' => $user->can(Permission::PERMISSION_MANAGER_MASTER_OBAT),
                        ]
                    ]
                ],
                [
                    'label' => $this->render('_label', [
                        'icon' => 'fa fa-users',
                        'title' => Yii::t('app', 'Pendaftaran')
                    ]),
                    'url' => ['/pendaftaran/pasien/index'],
                    'visible' => $user->can(Permission::PERMISSION_MANAGER_PENDAFTARAN_PASIEN)
                ],
            ];
            echo Menu::widget([
